# Microsoft Developer Studio Generated NMAKE File, Based on mdiplayer.dsp
!IF "$(CFG)" == ""
CFG=MDIPlayer - Win32 Release
!MESSAGE No configuration specified. Defaulting to MDIPlayer - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "MDIPlayer - Win32 Release" && "$(CFG)" !=\
 "MDIPlayer - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "mdiplayer.mak" CFG="MDIPlayer - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "MDIPlayer - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "MDIPlayer - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "MDIPlayer - Win32 Release"
...
CLEAN :
	-@erase "$(INTDIR)\MDIPlayer.obj"
	-@erase "$(INTDIR)\MDIPlayer.res"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(OUTDIR)\MDIPlayer.pdb"
	-@erase "..\MDIPlayer.exe"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /I "..\..\QTDevWin\CIncludes" /D "NDEBUG" /D\
 "WIN32" /D "_WINDOWS" /D pascal= /Fp"$(INTDIR)\mdiplayer.pch" /YX\
...
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\MDIPlayer.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\mdiplayer.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 ...
 /incremental:no /pdb:"$(OUTDIR)\MDIPlayer.pdb" /debug /machine:I386\
 /out:"..\MDIPlayer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\MDIPlayer.obj" \
	"$(INTDIR)\MDIPlayer.res"

"..\MDIPlayer.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "MDIPlayer - Win32 Debug"
...
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /I "..\..\QTDevWin\CIncludes" /D\
 "_DEBUG" /D "WIN32" /D "_WINDOWS" /D pascal= /Fp"$(INTDIR)\mdiplayer.pch" /YX\
 /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.
...
RSC=rc.exe
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\MDIPlayer.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\mdiplayer.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib\
 oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)\MDIPlayer.pdb" /debug /machine:I386\
 /out:"..\MDIPlayer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\MDIPlayer.obj" \
	"$(INTDIR)\MDIPlayer.res"
...
"$(INTDIR)\MDIPlayer.obj" : $(SOURCE) $(DEP_CPP_MDIPL) "$(INTDIR)"
...
"$(INTDIR)\MDIPlayer.res" : $(SOURCE) $(DEP_RSC_MDIPLA) "$(INTDIR)"
	$(RSC) $(RSC_PROJ) $(SOURCE)
