# Microsoft Developer Studio Generated NMAKE File, Based on QTMusic.dsp
!IF "$(CFG)" == ""
CFG=QTMusic - Win32 Release
!MESSAGE No configuration specified. Defaulting to QTMusic - Win32 Release.
!ENDIF 

!IF "$(CFG)" != "QTMusic - Win32 Release" && "$(CFG)" !=\
 "QTMusic - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "QTMusic.mak" CFG="QTMusic - Win32 Release"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "QTMusic - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "QTMusic - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
CLEAN :
	...
	-@erase "$(INTDIR)\QTMusic.obj"
	-@erase "$(INTDIR)\QTMusic.res"
	-@erase "$(INTDIR)\QTUtilities.obj"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(INTDIR)\WinFramework.obj"
	-@erase "$(OUTDIR)\QTMusic.exe"
	-@erase "$(OUTDIR)\QTMusic.ilk"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /ML /W3 /O2 /I "." /I "..\..\QTDevWin\CIncludes" /I\
 ".\Application Files" /I ".\Common Files" /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Release/
CPP_SBRS=.
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QTMusic.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QTMusic.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 ...
 /incremental:yes /pdb:"$(OUTDIR)\QTMusic.pdb" /machine:I386\
 /out:"$(OUTDIR)\QTMusic.exe" 
LINK32_OBJS= \
...
"$(OUTDIR)\QTMusic.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "QTMusic - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\QTMusic.exe"
	-@erase "$(OUTDIR)\QTMusic.ilk"
	-@erase "$(OUTDIR)\QTMusic.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MLd /W3 /Gm /Zi /Od /I "." /I "..\..\QTDevWin\CIncludes" /I\
 ".\Application Files" /I ".\Common Files" /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QTMusic.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QTMusic.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib\
 oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)\QTMusic.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\QTMusic.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
...
"$(INTDIR)\QTMusic.obj" : $(SOURCE) $(DEP_CPP_QTMUS) "$(INTDIR)"
...
SOURCE=".\Application Files\QTMusic.rc"
DEP_RSC_QTMUSI=\
	".\Application Files\ComResource.h"\
	".\Application Files\Movie.ico"\
	".\Application Files\QTMusic.ico"\
	

!IF  "$(CFG)" == "QTMusic - Win32 Release"


"$(INTDIR)\QTMusic.res" : $(SOURCE) $(DEP_RSC_QTMUSI) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QTMusic.res" /i "Application Files" /i\
