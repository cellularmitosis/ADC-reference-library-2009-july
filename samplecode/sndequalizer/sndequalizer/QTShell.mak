...
!IF "$(CFG)" != "QTShell - Win32 Release" && "$(CFG)" !=\
 "QTShell - Win32 Debug"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I ".\Common Files" /I ".\Application Files"\
 /I "..\..\QTDevWin\CIncludes" /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
...
LINK32_FLAGS=qtmlclient.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\QTShell.pdb" /machine:I386 /out:"$(OUTDIR)\QTShell.exe"\
...
LINK32_FLAGS=qtmlclient.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib\
 odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes\
 /pdb:"$(OUTDIR)\QTShell.pdb" /debug /machine:I386 /out:"$(OUTDIR)\QTShell.exe"\
 /pdbtype:sept /libpath:".\..\..\QTDevWin\Libraries" 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QTShell.res" \
...
DEP_RSC_QTSHE=\
	...
	".\Application Files\QTShell.ico"\
	

!IF  "$(CFG)" == "QTShell - Win32 Release"


"$(INTDIR)\QTShell.res" : $(SOURCE) $(DEP_RSC_QTSHE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QTShell.res" /i "Application Files" /d "NDEBUG"\
 $(SOURCE)
...
"$(INTDIR)\QTShell.res" : $(SOURCE) $(DEP_RSC_QTSHE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QTShell.res" /i "Application Files" /d "_DEBUG"\
 $(SOURCE)
