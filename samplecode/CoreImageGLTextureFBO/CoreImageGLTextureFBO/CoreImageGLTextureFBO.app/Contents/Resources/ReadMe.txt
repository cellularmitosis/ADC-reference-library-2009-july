...
This sample shows how to render with Core Image into a
...
Here we use the CIExposureAdjust filter to adjust the picture of a Rose, 
which seems to float on top of a reflective surface. 
