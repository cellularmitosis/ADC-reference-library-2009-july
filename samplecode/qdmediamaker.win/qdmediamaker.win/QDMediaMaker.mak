# Microsoft Developer Studio Generated NMAKE File, Based on QDMediaMaker.dsp
!IF "$(CFG)" == ""
CFG=QDMediaMaker - Win32 Debug
!MESSAGE No configuration specified. Defaulting to QDMediaMaker - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "QDMediaMaker - Win32 Release" && "$(CFG)" !=\
 "QDMediaMaker - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "QDMediaMaker.mak" CFG="QDMediaMaker - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "QDMediaMaker - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "QDMediaMaker - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "QDMediaMaker - Win32 Release"
...
CLEAN :
	...
	-@erase "$(INTDIR)\QDMMaker.obj"
	-@erase "$(INTDIR)\QDMMaker.res"
	-@erase "$(INTDIR)\QTUtilities.obj"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(INTDIR)\WinFramework.obj"
	-@erase "$(OUTDIR)\QDMediaMaker.exe"
	-@erase "$(OUTDIR)\QDMediaMaker.ilk"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /ML /W3 /GX /I "." /I ".\Common FIles" /I\
 ".\Application Files" /I "..\..\QTDevWin\CIncludes" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Release/
CPP_SBRS=.
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /o NUL /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QDMMaker.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QDMediaMaker.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 ...
 /incremental:yes /pdb:"$(OUTDIR)\QDMediaMaker.pdb" /machine:I386\
 /out:"$(OUTDIR)\QDMediaMaker.exe" 
LINK32_OBJS= \
...
"$(OUTDIR)\QDMediaMaker.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "QDMediaMaker - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\QDMediaMaker.exe"
	-@erase "$(OUTDIR)\QDMediaMaker.ilk"
	-@erase "$(OUTDIR)\QDMediaMaker.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MLd /W3 /Gm /Gi /GX /Zi /Od /I "." /I ".\Common FIles" /I\
 ".\Application Files" /I "..\..\QTDevWin\CIncludes" /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)\QDMediaMaker.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /o NUL /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QDMMaker.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QDMediaMaker.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib\
 oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)\QDMediaMaker.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\QDMediaMaker.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QDMMaker.obj" \
...
"$(INTDIR)\QDMMaker.obj" : $(SOURCE) $(DEP_CPP_QDMMA) "$(INTDIR)"
...
SOURCE=".\Application Files\QDMMaker.rc"
DEP_RSC_QDMMAK=\
	".\Application Files\ComResource.h"\
	".\Application Files\movie.ico"\
	".\Application Files\QDMMaker.ico"\
	

!IF  "$(CFG)" == "QDMediaMaker - Win32 Release"


"$(INTDIR)\QDMMaker.res" : $(SOURCE) $(DEP_RSC_QDMMAK) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QDMMaker.res" /i "Application Files" /d "NDEBUG"\
 $(SOURCE)
...
"$(INTDIR)\QDMMaker.res" : $(SOURCE) $(DEP_RSC_QDMMAK) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QDMMaker.res" /i "Application Files" /d "_DEBUG"\
 $(SOURCE)
