# Microsoft Developer Studio Generated NMAKE File, Based on QTController.dsp
!IF "$(CFG)" == ""
CFG=QTController - Win32 Debug
!MESSAGE No configuration specified. Defaulting to QTController - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "QTController - Win32 Release" && "$(CFG)" !=\
 "QTController - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "QTController.mak" CFG="QTController - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "QTController - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "QTController - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "QTController - Win32 Release"
...
CLEAN :
	...
	-@erase "$(INTDIR)\QTController.res"
	-@erase "$(INTDIR)\QTCustomButton.obj"
	-@erase "$(INTDIR)\QTUtilities.obj"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(INTDIR)\WinFramework.obj"
	-@erase "$(OUTDIR)\QTController.exe"
	-@erase "$(OUTDIR)\QTController.ilk"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "." /I ".\Common Files" /I\
 ".\Application Files" /I "..\..\QTDevWin\CIncludes" /D "WIN32" /D "NDEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)\QTController.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Release/
CPP_SBRS=.
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /o NUL /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QTController.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QTController.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=qtmlclient.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\QTController.pdb" /machine:I386\
 /out:"$(OUTDIR)\QTController.exe" /libpath:"..\..\QTDevWin\Libraries" 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QTController.res" \
	"$(INTDIR)\QTCustomButton.obj" \
	"$(INTDIR)\QTUtilities.obj" \
	"$(INTDIR)\WinFramework.obj"

"$(OUTDIR)\QTController.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "QTController - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\QTController.exe"
	-@erase "$(OUTDIR)\QTController.ilk"
	-@erase "$(OUTDIR)\QTController.pdb"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /I "." /I ".\Common Files" /I\
 ".\Application Files" /I "..\..\QTDevWin\CIncludes" /D "WIN32" /D "_DEBUG" /D\
 "_WINDOWS" /Fp"$(INTDIR)\QTController.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Debug/
CPP_SBRS=.
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /o NUL /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QTController.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QTController.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=qtmlclient.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib\
 odbc32.lib odbccp32.lib /nologo /subsystem:windows /incremental:yes\
 /pdb:"$(OUTDIR)\QTController.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\QTController.exe" /pdbtype:sept\
...
SOURCE=".\Application Files\QTController.rc"
DEP_RSC_QTCON=\
	".\Application Files\ComResource.h"\
	".\Application Files\Movie.ico"\
	".\Application Files\QTController.ico"\
	

!IF  "$(CFG)" == "QTController - Win32 Release"


"$(INTDIR)\QTController.res" : $(SOURCE) $(DEP_RSC_QTCON) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QTController.res" /i "Application Files" /d\
 "NDEBUG" $(SOURCE)
...
"$(INTDIR)\QTCustomButton.obj" : $(SOURCE) $(DEP_CPP_QTCUS) "$(INTDIR)"
