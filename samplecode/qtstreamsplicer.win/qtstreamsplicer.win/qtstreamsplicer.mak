# Microsoft Developer Studio Generated NMAKE File, Based on qtstreamsplicer.dsp
!IF "$(CFG)" == ""
CFG=qtstreamsplicer - Win32 Debug
!MESSAGE No configuration specified. Defaulting to qtstreamsplicer - Win32\
 Debug.
!ENDIF 

!IF "$(CFG)" != "qtstreamsplicer - Win32 Release" && "$(CFG)" !=\
 "qtstreamsplicer - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "qtstreamsplicer.mak" CFG="qtstreamsplicer - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "qtstreamsplicer - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "qtstreamsplicer - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
!IF  "$(CFG)" == "qtstreamsplicer - Win32 Release"
...
ALL : "$(OUTDIR)\qtstreamsplicer.exe"
...
CLEAN :
	...
	-@erase "$(INTDIR)\QTStreamSplicer.obj"
	-@erase "$(INTDIR)\QTStreamSplicer.res"
	-@erase "$(INTDIR)\QTUtilities.obj"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(INTDIR)\WinFramework.obj"
	-@erase "$(OUTDIR)\qtstreamsplicer.exe"
	-@erase "$(OUTDIR)\qtstreamsplicer.ilk"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "." /I ".\Application Files" /I\
 ...
 "_WINDOWS" /Fp"$(INTDIR)\qtstreamsplicer.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Release/
CPP_SBRS=.
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /o NUL /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QTStreamSplicer.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\qtstreamsplicer.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ..\..\QTDevWin\Libraries\qtmlclient.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)\qtstreamsplicer.pdb" /machine:I386\
 /out:"$(OUTDIR)\qtstreamsplicer.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QTStreamSplicer.obj" \
	"$(INTDIR)\QTStreamSplicer.res" \
	"$(INTDIR)\QTUtilities.obj" \
	"$(INTDIR)\WinFramework.obj"

"$(OUTDIR)\qtstreamsplicer.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\qtstreamsplicer.exe"
   MyRezWackRelease.bat
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"

!ELSEIF  "$(CFG)" == "qtstreamsplicer - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\qtstreamsplicer.exe"
	-@erase "$(OUTDIR)\qtstreamsplicer.ilk"
	-@erase "$(OUTDIR)\qtstreamsplicer.pdb"
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\QTStreamSplicer.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\qtstreamsplicer.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib\
 odbccp32.lib ..\..\QTDevWin\Libraries\qtmlclient.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)\qtstreamsplicer.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\qtstreamsplicer.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QTStreamSplicer.obj" \
...
"$(INTDIR)\QTStreamSplicer.obj" : $(SOURCE) $(DEP_CPP_QTSTR) "$(INTDIR)"
...
SOURCE=".\Application Files\QTStreamSplicer.rc"
DEP_RSC_QTSTRE=\
	".\Application Files\ComResource.h"\
	".\Application Files\Movie.ico"\
	".\Application Files\QTStreamSplicer.ico"\
	

!IF  "$(CFG)" == "qtstreamsplicer - Win32 Release"


"$(INTDIR)\QTStreamSplicer.res" : $(SOURCE) $(DEP_RSC_QTSTRE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\QTStreamSplicer.res" /i "Application Files" /d\
 "NDEBUG" $(SOURCE)
