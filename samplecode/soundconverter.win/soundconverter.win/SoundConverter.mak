# Microsoft Developer Studio Generated NMAKE File, Based on SoundConverter.dsp
!IF "$(CFG)" == ""
CFG=SoundConverter - Win32 Debug
!MESSAGE No configuration specified. Defaulting to SoundConverter - Win32\
 Debug.
!ENDIF 

!IF "$(CFG)" != "SoundConverter - Win32 Release" && "$(CFG)" !=\
 "SoundConverter - Win32 Debug"
...
CLEAN :
	...
	-@erase "$(INTDIR)\SoundConverter.obj"
	-@erase "$(INTDIR)\SoundConverter.res"
	-@erase "$(INTDIR)\vc50.idb"
	-@erase "$(INTDIR)\WinFramework.obj"
	-@erase "$(OUTDIR)\SoundConverter.exe"
	-@erase "$(OUTDIR)\SoundConverter.ilk"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /I "." /I ".\Application Files" /I\
 ...
 "_WINDOWS" /Fp"$(INTDIR)\SoundConverter.pch" /YX /Fo"$(INTDIR)\\"\
 /Fd"$(INTDIR)\\" /FD /c 
CPP_OBJS=.\Release/
CPP_SBRS=.
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /o NUL /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\SoundConverter.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\SoundConverter.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 ...
 /incremental:yes /pdb:"$(OUTDIR)\SoundConverter.pdb" /machine:I386\
 /out:"$(OUTDIR)\SoundConverter.exe" 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QTUtilities.obj" \
	"$(INTDIR)\SoundConverter.obj" \
	"$(INTDIR)\SoundConverter.res" \
	"$(INTDIR)\WinFramework.obj"

"$(OUTDIR)\SoundConverter.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN :
	...
	-@erase "$(OUTDIR)\SoundConverter.exe"
	-@erase "$(OUTDIR)\SoundConverter.ilk"
	-@erase "$(OUTDIR)\SoundConverter.pdb"
...
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\SoundConverter.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\SoundConverter.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=..\..\QTDevWin\Libraries\qtmlclient.lib kernel32.lib user32.lib\
 gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib\
 oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)\SoundConverter.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)\SoundConverter.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\ComApplication.obj" \
	"$(INTDIR)\ComFramework.obj" \
	"$(INTDIR)\QTUtilities.obj" \
...
"$(INTDIR)\SoundConverter.obj" : $(SOURCE) $(DEP_CPP_SOUND) "$(INTDIR)"
...
SOURCE=".\Application Files\SoundConverter.rc"
DEP_RSC_SOUNDC=\
	".\Application Files\ComResource.h"\
	".\Application Files\Movie.ico"\
	".\Application Files\SoundConverter.ico"\
	

!IF  "$(CFG)" == "SoundConverter - Win32 Release"


"$(INTDIR)\SoundConverter.res" : $(SOURCE) $(DEP_RSC_SOUNDC) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\SoundConverter.res" /i "Application Files" /d\
 "NDEBUG" $(SOURCE)
